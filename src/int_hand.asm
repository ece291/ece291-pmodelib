; IRQ Wrappers and handling functions
...
_OldIntVectors  times MAX_INTS*2 dd 0   ; Pointers to original interrupt handlers
_IntStacks      times INT_STACKS dd 0   ; Stacks for handler use (pointers into _StackData)
_IntHandlers    times MAX_INTS dd 0     ; Addresses of program interrupt handlers
_IntNumbers     times MAX_INTS dd 0     ; IRQ number the wrapper is allocated to
...
; Notes:   A maximum of MAX_IRQ interrupts may be hooked using this function.
;----------------------------------------
proc _Install_Int
...
%$handler       arg     4
        ...
        invoke  _LockArea, ds, dword _StackData, dword __end_StackData-_StackData
...
.FindWrapper:
        ...
        xor     eax, eax
        mov     ax, 0205h               ; [DPMI 0.9] Set Protected Mode Interrupt Vector
        mov     cx, [_OldIntVectors+ecx*4+4]    ; Selector of handler
        mov     edx, [_OldIntVectors+ecx*4]     ; Offset of handler
        int     31h
